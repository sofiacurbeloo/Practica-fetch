...
fetch(DATA_URL) //Realizo la peticion con fetch
.then(data=> data.json()) //luego de que cargue la informacion la pasamos a formato json
.then(data=> {
  let dataArray = data.students //guardo la lista de estudiantes
  showData(dataArray) //invoco la función para mostrarlo
